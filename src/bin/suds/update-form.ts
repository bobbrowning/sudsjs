...
module.exports = async function (
  permission: string, // Permission set of the current user
  table: string, // table / collection name
  id: Id, // record key (for MongoDB this is the hex string not the object)
  mode: Mode, // Operation to be performed
  entered: object, // record containing any presets
  loggedInUser: number, // ID of the logged in user
  ...
  ***************************************************** */
  ...
  function unpackInput(entered: object, attributes: Properties,): Record {
