...
export type TableData = {
  ...
  opengroup?: string;                                   /* When a single document is listed, this group is open */
  list?: {                                              /* Applies to a standard listing of the collection */
   ...
   groups?: {                                            
    [key: string]: {                                    /* Key value set where key is a code and value is an object for each: */
      ...
      permission?: string[];                            /*      Permission sets for this group */
      recordTypes?: string[];                          
...
export type Properties = { [key: string]: string & Property }; 

export type Property = {
  type?: "string" | "number" | "boolean" | "object" | "array";   /* Not required if there is a model */
  ...
  canEdit: boolean;                                    /* as above */
   ...
   items: {                                             /* Describes the items in an array or object */
