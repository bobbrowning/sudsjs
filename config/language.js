module.exports = {
  EN: {
    ...
    deleteRow: 'Delete',                                                // List Row
    deleteAYS: 'Are you sure you want to delete this item?',            // Delete Row
  ...
  <path d="M1.293 1.293a1 1 0 0 1 1.414 0L8 6.586l5.293-5.293a1 1 0 1 1 1.414 1.414L9.414 8l5.293 5.293a1 1 0 0 1-1.414 1.414L8 9.414l-5.293 5.293a1 1 0 0 1-1.414-1.414L6.586 8 1.293 2.707a1 1 0 0 1 0-1.414z"/>
    ...
    filter: 'Filter',                                                    // Filter button in condition row
    filterAgain: 'Another condition',                                    // Filter button in condition row
    filterList: 'Filter',                                      // Filter button on table list
  ...
  <path fill-rule="evenodd" d="M15.854 8.354a.5.5 0 0 0 0-.708l-3-3a.5.5 0 0 0-.708.708L14.293 7.5H5.5a.5.5 0 0 0 0 1h8.793l-2.147 2.146a.5.5 0 0 0 .708.708l3-3z"/>
    ...
    listRowHelpView: 'Click here to  view this row',            // Tootip over 'more...' on table listing
    listRowHelpEdit: 'Click here to  edit this row',            // Tootip over 'more...' on table listing
    lt: 'less than',
    login: 'Log in',
