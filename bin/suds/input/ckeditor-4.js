...
module.exports = async function (fieldType, fieldName, fieldValue, attributes, errorMsg) {
  ...
  let headerTags = suds.inputTypes.ckeditor4.headerTags;
  let height = 100;
  ...
  if (suds.inputTypes.ckeditor4.formats) {
    ...
    /** Create format_tags  */
    let formats = suds.inputTypes.ckeditor4.formats;
  ...
  /** style items */
  let stylesconfig = suds.inputTypes.ckeditor4.styles;
  if (stylesconfig) {
  ...
  if (suds.inputTypes.ckeditor4.editorplaceholder) replaceParms += `
