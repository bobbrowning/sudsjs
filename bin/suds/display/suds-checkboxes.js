...
var lang = require('../../config/language')['EN'];
var tableDataFunction = require('./table-data');
module.exports = function (attributes, fieldValue) {
    return __awaiter(this, arguments, void 0, function () {
        var trace, results, checked, values, labels, fieldValues, i, rowTitle, i, i, i;
